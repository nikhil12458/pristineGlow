...
const candleData = [
  ...
  {
    id: 25,
    slug: "heart-shaped-glass-candle",
    mainImg: "/img/heart-shaped-glass-candle.webp",
    name: "Valentine Heart Shaped Candle",
    description: "Bold poker-themed jar candle with a masculine aesthetic.",
    category: "valentine",
    fragrance: "Woody Musk",
    price: 999,
    stock: 5,
    prop: "/prop/prop6.webp",
    backgroundColor: "#fed2e9",
    images: ["/img/heart-shaped-glass-candle.webp"],
  },
  {
    id: 26,
    slug: "heart-shaped-bowl-candle",
    mainImg: "/img/heart-shaped-bowl-candle.webp",
    name: "Heart Shaped Bowl Candle",
    description: "Minimal soy wax candle in a reusable tin container.",
    category: "valentine",
    fragrance: "Lavender",
    price: 799,
    stock: 20,
    prop: "/prop/prop1.png",
    backgroundColor: "#c59e9e",
    images: ["/img/heart-shaped-bowl-candle.webp"],
  },
  {
    id: 27,
    slug: "valentine-candles",
    mainImg: "/img/valentine-candles.webp",
    name: "Valentine Candles",
    description: "Bold poker-themed jar candle with a masculine aesthetic.",
    category: "valentine",
    fragrance: "Woody Musk",
    price: 999,
    ...
    prop: "/prop/prop6.webp",
    backgroundColor: "#FEEFD2",
    images: ["/img/valentine-candles.webp"],
  },
  {
    id: 28,
    slug: "heart-shaped-flower-candle",
    mainImg: "/img/heart-shaped-flower-candle.webp",
    name: "Heart Shaped Flower Candle",
    description: "Classic tealight candle for everyday use and decor.",
    category: "valentine",
    fragrance: "Unscented",
    price: 299,
    ...
    prop: "/prop/prop3.webp",
    backgroundColor: "#FEE6C6",
    images: ["/img/heart-shaped-flower-candle.webp"],
  },
  {
    id: 29,
    slug: "valentine-rose-candle",
    mainImg: "/img/valentine-rose-candle.webp",
    ...
    stock: 20,
    prop: "/prop/prop6.webp",
    backgroundColor: "#fdc9df",
    images: ["/img/valentine-rose-candle.webp"],
  },
  {
    id: 30,
    slug: "valentine-name-mold-candle",
    mainImg: "/img/valentine-name-mold-candle.webp",
    name: "Valentine Name Mold Candle",
    description: "Rose-shaped decorative candle for elegant interiors.",
    category: "valentine",
    fragrance: "Rose",
    price: 899,
    stock: 10,
    prop: "/prop/prop1.png",
    backgroundColor: "#d0e4e3",
    images: ["/img/valentine-name-mold-candle.webp"],
  },
];
